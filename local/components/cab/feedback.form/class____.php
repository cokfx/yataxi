...
class FeedbackFormHandler extends CBitrixComponent
{
    ...
    private function getResult($arParams)
    {
        ...
        $arResult['ELEMENT_PROPERTIES'] = $this->getElementProperties();

        $arResult['TEST'] = $this->getPropertiesListEdit()["PROPERTY_LIST_FULL"];
        $arResult['REQUEST'] = $this->getRequestData();
        $arResult['ADDED'] = $this->addElement();
        $arResult['ID'] = $this->prepairParams()['UPDATE_VALUES'];
        return $arResult;
    }
